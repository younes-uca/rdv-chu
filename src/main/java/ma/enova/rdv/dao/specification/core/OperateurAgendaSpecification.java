...
public class OperateurAgendaSpecification extends AbstractSpecification<OperateurAgendaCriteria, OperateurAgenda> {

    public OperateurAgendaSpecification(OperateurAgendaCriteria criteria) {
        super(criteria);
    }

    public OperateurAgendaSpecification(OperateurAgendaCriteria criteria, boolean distinct) {
        super(criteria, distinct);
    }


    @Override
    public Predicate toPredicate(Root<OperateurAgenda> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
