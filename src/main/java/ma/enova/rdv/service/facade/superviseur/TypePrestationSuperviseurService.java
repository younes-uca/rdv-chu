...
public interface TypePrestationSuperviseurService extends IService<TypePrestation, TypePrestationDto,TypePrestationCriteria, TypePrestationHistoryCriteria> {
