...
public interface OperateurAgendaPatientService extends IService<OperateurAgenda, OperateurAgendaDto,OperateurAgendaCriteria, OperateurAgendaHistoryCriteria> {
