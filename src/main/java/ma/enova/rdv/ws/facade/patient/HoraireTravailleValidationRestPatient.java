...
@RestController
@RequestMapping("/api/patient/horaireTravailleValidation")
public class HoraireTravailleValidationRestPatient  extends AbstractController<HoraireTravailleValidation, HoraireTravailleValidationDto, HoraireTravailleValidationHistory, HoraireTravailleValidationCriteria, HoraireTravailleValidationHistoryCriteria, HoraireTravailleValidationPatientService, HoraireTravailleValidationConverter> {
...
//    }
    ...
    public HoraireTravailleValidationRestPatient (HoraireTravailleValidationPatientService service, HoraireTravailleValidationConverter converter) {
