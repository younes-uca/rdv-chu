...
@RestController
@RequestMapping("/api/patient/etablissement")
public class EtablissementRestPatient  extends AbstractController<Etablissement, EtablissementDto, EtablissementHistory, EtablissementCriteria, EtablissementHistoryCriteria, EtablissementPatientService, EtablissementConverter> {
...
//    }
    ...
    public EtablissementRestPatient (EtablissementPatientService service, EtablissementConverter converter) {
