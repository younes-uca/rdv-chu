...
@RestController
@RequestMapping("/api/superviseur/prestation")
public class PrestationRestSuperviseur  extends AbstractController<Prestation, PrestationDto, PrestationHistory, PrestationCriteria, PrestationHistoryCriteria, PrestationSuperviseurService, PrestationConverter> {
...
//    }
    ...
    public PrestationRestSuperviseur (PrestationSuperviseurService service, PrestationConverter converter) {
