...
@RestController
@RequestMapping("/api/admin/hopital")
public class HopitalRestAdmin  extends AbstractController<Hopital, HopitalDto, HopitalHistory, HopitalCriteria, HopitalHistoryCriteria, HopitalAdminService, HopitalConverter> {
...
//    }
    ...
    public HopitalRestAdmin (HopitalAdminService service, HopitalConverter converter) {
