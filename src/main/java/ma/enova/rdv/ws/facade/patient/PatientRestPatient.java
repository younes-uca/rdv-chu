...
public class PatientRestPatient  extends AbstractController<Patient, PatientDto, PatientHistory, PatientCriteria, PatientHistoryCriteria, PatientPatientService, PatientConverter> {
...
//    }
    ...
    public PatientRestPatient (PatientPatientService service, PatientConverter converter) {
