...
@RestController
@RequestMapping("/api/patient/typePrestation")
public class TypePrestationRestPatient  extends AbstractController<TypePrestation, TypePrestationDto, TypePrestationHistory, TypePrestationCriteria, TypePrestationHistoryCriteria, TypePrestationPatientService, TypePrestationConverter> {
...
//    }
    ...
    public TypePrestationRestPatient (TypePrestationPatientService service, TypePrestationConverter converter) {
