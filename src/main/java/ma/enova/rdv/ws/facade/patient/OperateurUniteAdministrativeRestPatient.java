...
@RestController
@RequestMapping("/api/patient/operateurUniteAdministrative")
public class OperateurUniteAdministrativeRestPatient  extends AbstractController<OperateurUniteAdministrative, OperateurUniteAdministrativeDto, OperateurUniteAdministrativeHistory, OperateurUniteAdministrativeCriteria, OperateurUniteAdministrativeHistoryCriteria, OperateurUniteAdministrativePatientService, OperateurUniteAdministrativeConverter> {
...
//    }
    ...
    public OperateurUniteAdministrativeRestPatient (OperateurUniteAdministrativePatientService service, OperateurUniteAdministrativeConverter converter) {
