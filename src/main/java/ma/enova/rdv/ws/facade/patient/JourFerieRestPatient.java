...
@RestController
@RequestMapping("/api/patient/jourFerie")
public class JourFerieRestPatient  extends AbstractController<JourFerie, JourFerieDto, JourFerieHistory, JourFerieCriteria, JourFerieHistoryCriteria, JourFeriePatientService, JourFerieConverter> {
...
//    }
    ...
    public JourFerieRestPatient (JourFeriePatientService service, JourFerieConverter converter) {
