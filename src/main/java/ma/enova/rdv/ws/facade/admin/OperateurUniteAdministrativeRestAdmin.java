...
@RestController
@RequestMapping("/api/admin/operateurUniteAdministrative")
public class OperateurUniteAdministrativeRestAdmin  extends AbstractController<OperateurUniteAdministrative, OperateurUniteAdministrativeDto, OperateurUniteAdministrativeHistory, OperateurUniteAdministrativeCriteria, OperateurUniteAdministrativeHistoryCriteria, OperateurUniteAdministrativeAdminService, OperateurUniteAdministrativeConverter> {
...
//    }
    ...
    public OperateurUniteAdministrativeRestAdmin (OperateurUniteAdministrativeAdminService service, OperateurUniteAdministrativeConverter converter) {
