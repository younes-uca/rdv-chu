...
@RestController
@RequestMapping("/api/patient/celluleValidation")
public class CelluleValidationRestPatient  extends AbstractController<CelluleValidation, CelluleValidationDto, CelluleValidationHistory, CelluleValidationCriteria, CelluleValidationHistoryCriteria, CelluleValidationPatientService, CelluleValidationConverter> {
...
//    }
    ...
    public CelluleValidationRestPatient (CelluleValidationPatientService service, CelluleValidationConverter converter) {
