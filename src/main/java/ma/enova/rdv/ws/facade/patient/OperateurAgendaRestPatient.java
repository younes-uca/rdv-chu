...
@RestController
@RequestMapping("/api/patient/operateurAgenda")
public class OperateurAgendaRestPatient  extends AbstractController<OperateurAgenda, OperateurAgendaDto, OperateurAgendaHistory, OperateurAgendaCriteria, OperateurAgendaHistoryCriteria, OperateurAgendaPatientService, OperateurAgendaConverter> {
...
//    }
    ...
    public OperateurAgendaRestPatient (OperateurAgendaPatientService service, OperateurAgendaConverter converter) {
