...
@RestController
@RequestMapping("/api/superviseur/patient")
public class PatientRestSuperviseur  extends AbstractController<Patient, PatientDto, PatientHistory, PatientCriteria, PatientHistoryCriteria, PatientSuperviseurService, PatientConverter> {
...
//    }
    ...
    public PatientRestSuperviseur (PatientSuperviseurService service, PatientConverter converter) {
