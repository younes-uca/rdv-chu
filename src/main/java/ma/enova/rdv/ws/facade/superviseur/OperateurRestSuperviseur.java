...
@RestController
@RequestMapping("/api/superviseur/operateur")
public class OperateurRestSuperviseur  extends AbstractController<Operateur, OperateurDto, OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurSuperviseurService, OperateurConverter> {
...
//    }
    ...
    public OperateurRestSuperviseur (OperateurSuperviseurService service, OperateurConverter converter) {
