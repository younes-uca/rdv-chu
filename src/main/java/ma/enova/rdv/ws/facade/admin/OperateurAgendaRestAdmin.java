...
@RestController
@RequestMapping("/api/admin/operateurAgenda")
public class OperateurAgendaRestAdmin  extends AbstractController<OperateurAgenda, OperateurAgendaDto, OperateurAgendaHistory, OperateurAgendaCriteria, OperateurAgendaHistoryCriteria, OperateurAgendaAdminService, OperateurAgendaConverter> {
...
//    }
    ...
    public OperateurAgendaRestAdmin (OperateurAgendaAdminService service, OperateurAgendaConverter converter) {
