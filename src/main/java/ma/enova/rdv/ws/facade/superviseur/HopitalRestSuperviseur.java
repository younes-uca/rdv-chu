...
@RestController
@RequestMapping("/api/superviseur/hopital")
public class HopitalRestSuperviseur  extends AbstractController<Hopital, HopitalDto, HopitalHistory, HopitalCriteria, HopitalHistoryCriteria, HopitalSuperviseurService, HopitalConverter> {
...
//    }
    ...
    public HopitalRestSuperviseur (HopitalSuperviseurService service, HopitalConverter converter) {
