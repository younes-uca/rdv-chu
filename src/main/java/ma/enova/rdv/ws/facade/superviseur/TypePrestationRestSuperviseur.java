...
@RestController
@RequestMapping("/api/superviseur/typePrestation")
public class TypePrestationRestSuperviseur  extends AbstractController<TypePrestation, TypePrestationDto, TypePrestationHistory, TypePrestationCriteria, TypePrestationHistoryCriteria, TypePrestationSuperviseurService, TypePrestationConverter> {
...
//    }
    ...
    public TypePrestationRestSuperviseur (TypePrestationSuperviseurService service, TypePrestationConverter converter) {
