...
@RestController
@RequestMapping("/api/patient/operateurHoraireTravailleValidation")
public class OperateurHoraireTravailleValidationRestPatient  extends AbstractController<OperateurHoraireTravailleValidation, OperateurHoraireTravailleValidationDto, OperateurHoraireTravailleValidationHistory, OperateurHoraireTravailleValidationCriteria, OperateurHoraireTravailleValidationHistoryCriteria, OperateurHoraireTravailleValidationPatientService, OperateurHoraireTravailleValidationConverter> {
...
//    }
    ...
    public OperateurHoraireTravailleValidationRestPatient (OperateurHoraireTravailleValidationPatientService service, OperateurHoraireTravailleValidationConverter converter) {
