...
@RestController
@RequestMapping("/api/admin/operateurQuota")
public class OperateurQuotaRestAdmin  extends AbstractController<OperateurQuota, OperateurQuotaDto, OperateurQuotaHistory, OperateurQuotaCriteria, OperateurQuotaHistoryCriteria, OperateurQuotaAdminService, OperateurQuotaConverter> {
...
//    }
    ...
    public OperateurQuotaRestAdmin (OperateurQuotaAdminService service, OperateurQuotaConverter converter) {
