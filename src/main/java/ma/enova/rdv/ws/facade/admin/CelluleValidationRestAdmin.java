...
@RestController
@RequestMapping("/api/admin/celluleValidation")
public class CelluleValidationRestAdmin  extends AbstractController<CelluleValidation, CelluleValidationDto, CelluleValidationHistory, CelluleValidationCriteria, CelluleValidationHistoryCriteria, CelluleValidationAdminService, CelluleValidationConverter> {
...
//    }
    ...
    public CelluleValidationRestAdmin (CelluleValidationAdminService service, CelluleValidationConverter converter) {
