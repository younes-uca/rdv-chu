...
@RestController
@RequestMapping("/api/patient/operateur")
public class OperateurRestPatient  extends AbstractController<Operateur, OperateurDto, OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurPatientService, OperateurConverter> {
...
//    }
    ...
    public OperateurRestPatient (OperateurPatientService service, OperateurConverter converter) {
