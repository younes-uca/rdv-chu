...
@RestController
@RequestMapping("/api/superviseur/statusRdv")
public class StatusRdvRestSuperviseur  extends AbstractController<StatusRdv, StatusRdvDto, StatusRdvHistory, StatusRdvCriteria, StatusRdvHistoryCriteria, StatusRdvSuperviseurService, StatusRdvConverter> {
...
//    }
    ...
    public StatusRdvRestSuperviseur (StatusRdvSuperviseurService service, StatusRdvConverter converter) {
