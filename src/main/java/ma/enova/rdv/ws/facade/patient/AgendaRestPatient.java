...
@RestController
@RequestMapping("/api/patient/agenda")
public class AgendaRestPatient  extends AbstractController<Agenda, AgendaDto, AgendaHistory, AgendaCriteria, AgendaHistoryCriteria, AgendaPatientService, AgendaConverter> {
...
//    }
    ...
    public AgendaRestPatient (AgendaPatientService service, AgendaConverter converter) {
