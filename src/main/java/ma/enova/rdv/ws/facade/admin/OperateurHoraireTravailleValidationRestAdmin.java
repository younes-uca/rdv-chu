...
@RestController
@RequestMapping("/api/admin/operateurHoraireTravailleValidation")
public class OperateurHoraireTravailleValidationRestAdmin  extends AbstractController<OperateurHoraireTravailleValidation, OperateurHoraireTravailleValidationDto, OperateurHoraireTravailleValidationHistory, OperateurHoraireTravailleValidationCriteria, OperateurHoraireTravailleValidationHistoryCriteria, OperateurHoraireTravailleValidationAdminService, OperateurHoraireTravailleValidationConverter> {
...
//    }
    ...
    public OperateurHoraireTravailleValidationRestAdmin (OperateurHoraireTravailleValidationAdminService service, OperateurHoraireTravailleValidationConverter converter) {
