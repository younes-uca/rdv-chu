...
@RestController
@RequestMapping("/api/admin/causeRejetDemandeRdv")
public class CauseRejetDemandeRdvRestAdmin  extends AbstractController<CauseRejetDemandeRdv, CauseRejetDemandeRdvDto, CauseRejetDemandeRdvHistory, CauseRejetDemandeRdvCriteria, CauseRejetDemandeRdvHistoryCriteria, CauseRejetDemandeRdvAdminService, CauseRejetDemandeRdvConverter> {
...
//    }
    ...
    public CauseRejetDemandeRdvRestAdmin (CauseRejetDemandeRdvAdminService service, CauseRejetDemandeRdvConverter converter) {
