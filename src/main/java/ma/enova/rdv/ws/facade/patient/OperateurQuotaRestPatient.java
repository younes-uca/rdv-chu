...
@RestController
@RequestMapping("/api/patient/operateurQuota")
public class OperateurQuotaRestPatient  extends AbstractController<OperateurQuota, OperateurQuotaDto, OperateurQuotaHistory, OperateurQuotaCriteria, OperateurQuotaHistoryCriteria, OperateurQuotaPatientService, OperateurQuotaConverter> {
...
//    }
    ...
    public OperateurQuotaRestPatient (OperateurQuotaPatientService service, OperateurQuotaConverter converter) {
