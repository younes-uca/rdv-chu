...
@RestController
@RequestMapping("/api/admin/statusRdv")
public class StatusRdvRestAdmin  extends AbstractController<StatusRdv, StatusRdvDto, StatusRdvHistory, StatusRdvCriteria, StatusRdvHistoryCriteria, StatusRdvAdminService, StatusRdvConverter> {
...
//    }
    ...
    public StatusRdvRestAdmin (StatusRdvAdminService service, StatusRdvConverter converter) {
