...
@RestController
@RequestMapping("/api/patient/prestation")
public class PrestationRestPatient  extends AbstractController<Prestation, PrestationDto, PrestationHistory, PrestationCriteria, PrestationHistoryCriteria, PrestationPatientService, PrestationConverter> {
...
//    }
    ...
    public PrestationRestPatient (PrestationPatientService service, PrestationConverter converter) {
