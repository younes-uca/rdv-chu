...
@RestController
@RequestMapping("/api/admin/horaireTravailleValidation")
public class HoraireTravailleValidationRestAdmin  extends AbstractController<HoraireTravailleValidation, HoraireTravailleValidationDto, HoraireTravailleValidationHistory, HoraireTravailleValidationCriteria, HoraireTravailleValidationHistoryCriteria, HoraireTravailleValidationAdminService, HoraireTravailleValidationConverter> {
...
//    }
    ...
    public HoraireTravailleValidationRestAdmin (HoraireTravailleValidationAdminService service, HoraireTravailleValidationConverter converter) {
